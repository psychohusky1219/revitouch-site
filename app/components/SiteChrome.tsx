...
export function Footer(){return <footer><div className="footer-content"><a className="footer-brand" href="/"><img src="/images/logo.png" alt="ReviTouch" /></a><div><p>Massage therapy and laser services in New York City.</p><p>© 2026 ReviTouch. All rights reserved.</p></div><div className="footer-links"><a href="/treatments">Massage</a><a href="/laser">Laser</a><a href="/about">About</a><a href="/gift-cards">Gift Cards</a><a href="/contact">Contact</a></div></div><div className="announcement footer-announcement">Women-owned wellness studio · New York City <a href="tel:+19178913456">Call or text (917) 891-3456</a></div></footer>}
